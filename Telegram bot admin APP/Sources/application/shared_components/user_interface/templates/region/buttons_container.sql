...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24800333822007463630)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24780591203759381774)
,p_plug_template_id=>wwv_flow_api.id(24800333822007463630)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24780591702552381774)
,p_plug_template_id=>wwv_flow_api.id(24800333822007463630)
,p_name=>'Sub Regions'
