...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24800333019779463629)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24780589080983381775)
,p_plug_template_id=>wwv_flow_api.id(24800333019779463629)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24780589614776381775)
,p_plug_template_id=>wwv_flow_api.id(24800333019779463629)
,p_name=>'Sub Regions'
